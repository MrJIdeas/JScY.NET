...
AF_Potential2D<WF_2D> afpot1 = new AF_Potential2D<WF_2D>("PotMitte", 40 * test.DimX / 100, 60 * test.DimX / 100, 0, test.DimY, 10, 5);
AF_Potential2D<WF_2D> afpot2 = new AF_Potential2D<WF_2D>("PotMitte", 0, test.DimX, 40 * test.DimY / 100, 60 * test.DimY / 100, 10, 5);
