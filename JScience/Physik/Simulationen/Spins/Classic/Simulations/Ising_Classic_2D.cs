...
namespace JScience.Physik.Simulationen.Spins.Classic.Simulations
{
    public class Ising_Classic_2D : Ising_Classic_3D
    {
        ...
        public Ising_Classic_2D(double j, double b, double t, uint dimX, uint dimY, uint MaxSteps, EParticleType types, ELatticeBoundary boundary, uint StepsPerSaving) :
