...
{
    public class ImaginaryLinearPotential : ImaginaryBlockPotential
    {
        public readonly EShift Direction;

        public ImaginaryLinearPotential(string name, int xSTART, int xEND, double damping, EShift direction) : base(name, xSTART, xEND, damping) => Direction = direction;

        public ImaginaryLinearPotential(string name, int xSTART, int xEND, int ySTART, int yEND, double damping, EShift direction) : base(name, xSTART, xEND, ySTART, yEND, damping) => Direction = direction;

        public ImaginaryLinearPotential(string name, int xSTART, int ySTART, int xEND, int yEND, int zSTART, int zEND, double Vmax, EShift direction) : base(name, xSTART, ySTART, xEND, yEND, zSTART, zEND, Vmax) => Direction = direction;

        public override IWavefunction getPsiV(WFInfo wfinfo)
        {
            var erg = base.getPsiV(wfinfo);
